$srcPath = "c:\Users\Admin\Downloads\index.html"
$destPath = "c:\Users\Admin\Downloads\project.html"
...
# 2. Replace HERO to WORKS with ARCHIVE HERO and ARCHIVE GRID
$bodySearch = '(?s)<!-- ═══ HERO ═══ -->.*?<!-- ═══ GRAND FOOTER ═══ -->'
$bodyReplace = '<!-- ═══ ARCHIVE HERO ═══ -->
    ...
    <!-- ═══ GRAND FOOTER ═══ -->'
$content = [regex]::Replace($content, $bodySearch, $bodyReplace, 1)
...
# 5. Intro HTML replacement
$introHtmlSearch = '(?s)  <!-- ── INTRO SCREEN ── -->.*?<div class="intro-counter" id="intro-counter">000</div>\s*</div>'
$introHtmlReplace = ''
$content = [regex]::Replace($content, $introHtmlSearch, $introHtmlReplace, 1)
...
# 7. Navigation Archive Text
$navSearch = '<span>Graphic Designer</span>'
$navReplace = '<span>Archive</span>'
